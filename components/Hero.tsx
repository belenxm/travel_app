  ...
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row border-2'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        <p className='regular mt-6 text-gray-30 xl:max-w[520px]'>
        ...
        {/* Reviews */}
          <p className='bold-16 lg:bold-20 text-blue-70'>
            198k
            <span className='regular-16 lg:regular-20 ml-1 underline'>Excellente Reviews</span>
          </p>
        </div>
    ...
    <div className='relative flex flex-1 items-start '>
      <div className='relative z-20 fle w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
